defmodule NoizuTeamsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NoizuTeamsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NoizuTeamsWeb.Gettext, "errors", msg, opts)
    end
  end
