...
config :noizu_teams, NoizuTeamsWeb.Guardian.AuthPipeline,
       module: NoizuTeamsWeb.Guardian,
       error_handler: NoizuTeamsWeb.Guardian.AuthErrorHandler
...
config :noizu_teams, NoizuTeamsWeb.Endpoint,
  ...
  pubsub_server: NoizuTeams.PubSub,
  live_view: [signing_salt: "BJySqGWs"]
...
config :noizu_teams, NoizuTeams.Mailer, adapter: Swoosh.Adapters.Local
